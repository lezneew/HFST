...
\begin{document}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Frequency response of the root mean square voltage V\textsubscript{rms} of Emitter and Kaskode circuits \cite{praktikum}}
		\label{fig: freqgang}
	\end{figure}
...
%				};
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Amplification of the root mean square voltage V\textsubscript{rms} of Emitter and Kaskode circuits \cite{praktikum} at their saturation frequencies.}
		\label{fig: amplif}
	\end{figure}
